...
useLayoutEffect (() => {
  ...
  return (
    <SafeAreaView>
      {/*first*/}
        <View className= "flex-row px-5 - mt-3 items-center space-x-64">
        ...
        {/*Second section*/}
        <View className="items-center justify-center px-6 mt-4 space-y-4">
          <Text className=" text-[#3C6072] text-[27px]">Bài tập 3: Khởi động chuyên môn</Text>
          </View>
        ...
        <View className="px-8 mt-3">
         ...
         <View className="px-5 mt-6 space-x-10 flex-row items-center justify-center">
