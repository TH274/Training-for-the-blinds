        ...
        <SafeAreaView>
          {/*first*/}
            ...
            <View className="items-center px-6 mt-5 space-y-4">
              <Text className=" text-[#3C6072] text-[23px]">Bài tập 9: Kéo dãn phần vai và hông</Text>
              </View>
            ...
            <View className="px-8 mt-3">
             ...
             <View className="px-5 mt-8 space-x-10 flex-row items-center justify-center">
              <TouchableOpacity onPress={() => navigation.navigate("Excercise10")}>
